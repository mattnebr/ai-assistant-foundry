...
- **extracting-code-structure → finding-files**: Find files of a specific type, then get structure
...
- **extracting-code-structure → querying-json/querying-yaml**: Understand API structures before extracting data

### In Refactoring Workflows
- **extracting-code-structure → fuzzy-selecting → analyzing-code-structure**: Interactive selection of components to refactor
- **extracting-code-structure → searching-text → replacing-text**: Find patterns and perform replacements

### For Documentation and Analysis
- **extracting-code-structure → analyzing-code**: Get statistics for specific code components
- **extracting-code-structure → viewing-files**: View structure with syntax highlighting

### Multi-Skill Workflows
- **extracting-code-structure → searching-text → analyzing-code-structure → viewing-files**: Complete code analysis and refactoring pipeline
- **extracting-code-structure → finding-files → querying-json/querying-yaml**: Find and analyze configuration structures
- **extracting-code-structure → fuzzy-selecting → replacing-text**: Interactive selection and modification of code elements
