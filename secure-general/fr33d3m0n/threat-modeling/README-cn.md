...
- 全面审计和优化代码质量，更好地符合当前 Skill 规范
- 显著增强针对 Agent 和 Skill 的安全分析和评估能力
- 完整覆盖 OWASP MCP Top 10 (2025)，采用官方 MCP01:2025-MCP10:2025 编号体系
- SAO 行为模型（Subject-Action-Object），用于系统化枚举 Agent 威胁
- 13 条预置 Agent 攻击链，含 MITRE ATT&CK 技术序列
- 信任反转模型，形式化 SKILL.MD = UNTRUSTED 的 Agent 安全范式
